...
Future<({AuthRepository repository, Dio dio, DemoAdapter adapter})> _create(
...
Future<Result<User>> _login(AuthRepository repository) =>
...
void main() {
  ...
  test('transient session failures preserve credentials for retry', () async {
    ...
    expect(fixture.repository.currentUser, isNotNull);
  });
